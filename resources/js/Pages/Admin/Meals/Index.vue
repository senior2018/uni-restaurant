        ...
        <div class="p-6 bg-gray-50 min-h-screen">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <button
                        v-if="searchQuery || availabilityFilter !== 'all' || categoryFilter !== 'all'"
                ...
                <div v-if="hasActiveFilters" class="mt-4 flex flex-wrap gap-2">
                    ...
                    <span v-if="availabilityFilter !== 'all'" class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                        {{ availabilityFilter === 'available' ? 'Available' : 'Unavailable' }}
                        <button @click="availabilityFilter = 'all'" class="ml-1 text-green-600 hover:text-green-800">×</button>
                    </span>
            ...
            <div class="mt-8 text-center text-gray-600">
                <p class="text-sm">
                    ...
                    <span v-if="filteredMeals.length > 0">
                        • {{ filteredMeals.filter(meal => meal.is_available).length }} available
                        • {{ filteredMeals.filter(meal => !meal.is_available).length }} unavailable
                    </span>
                </p>
            </div>
        </div>
...
const hasActiveFilters = computed(() => {
    return searchQuery.value || availabilityFilter.value !== 'all' || categoryFilter.value !== 'all';
});
